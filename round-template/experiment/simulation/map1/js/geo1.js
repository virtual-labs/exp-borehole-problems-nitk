...
$(function()
{
	...
	$('#step10-1').click(function()
	{
		...
		$('#resultContainer').html('<img id="ctmap" style="position: absolute; left: 55px; top: 120px;" src="images/ctrmap2.png"/>');
	});
	$('#step10-2').click(function()
	{
		$('#resultContainer').empty();
	 ...
	 $('#simscreen').mousemove(function(event){
		 ...
		 if(sp==true)
		 {
			 if(xx>=196 && xx<=199 && yy>=335 && yy<=340)
			 {
			 ...
			 else if(xx>=230 && xx<=235 && yy>=370 && yy<=375)
			 {
			  ...
			  else if(xx>=265 && xx<=270 && yy>=405 && yy<=410)
			 {
			  ...
			  else if(xx>=300 && xx<=305 && yy>=440 && yy<=445)
			 {
			  ...
			  else if(xx>=335 && xx<=340 && yy>=440 && yy<=445)
			 {
			  ...
			  else if(xx>=370 && xx<=375 && yy>=405 && yy<=410)
			 {
			  ...
			  else if(xx>=412 && xx<=417 && yy>=370 && yy<=375)
			 {
			  ...
			  else if(xx>=447 && xx<=452 && yy>=335 && yy<=340)
			 {
			  ...
			  else if(xx>=485 && xx<=490 && yy>=335 && yy<=340)
			 {
			  ...
			  else if(xx>=517 && xx<=522 && yy>=370 && yy<=375)
			 {
			  ...
			  else if(xx>=555 && xx<=560 && yy>=405 && yy<=410)
			 {
			  ...
			  else if(xx>=594 && xx<=595 && yy>=405 && yy<=410)
			 {
			  ...
			  else if(xx>=634 && xx<=639 && yy>=370 && yy<=375)
			 {
			  ...
			  else if(xx>=668 && xx<=673 && yy>=335 && yy<=340)
			 {
			   ...
			   else if(xx>=383 && xx<=389 && yy>=389 && yy<=397)
			 {
				$('#tooltip-span').text("Borehole Point(680,370)");    
				$('#tooltip-span').css({
				  position:'absolute',
				  top:event.pageY,
				  left:event.pageX+20,
...
{
	document.getElementById('arrow1').style="visibility:visible ;position:absolute; left:"+left+"px; top: "+top+"px; height: 25px; z-index: 10;";
...
function magic()
{
	if(simsubscreennum == 1)
	{
		...
		setTimeout(function()
		{
			animateArrowATPosition(304,230,270);
			document.getElementById("arrow1").style.animation = "arrowMove 0.8s forwards";
		},500);
		setTimeout(function()
		{
			document.getElementById('boreholePoint').style.visibility="visible";
			setTimeout(function()
			{
			...
			setTimeout(function()
			{
				document.getElementById('fullmap').src = "images/ctrmap2.png";
				...
				document.getElementById('boreholePoint').style.visibility="hidden";
			},3000);
		},800);
	...
	else if(simsubscreennum == 6)
	{
		...
		document.getElementById('cmap').innerHTML = "Mark Borehole ";
		spanclick=13;
	}
	...
	else if(simsubscreennum == 8)
	{
		...
		generateQuestion(q1,"In the formula Index =((N-M)/(S+1))*(T+1) + M, what does S indicate?","","number of solid lines between the obtained dotted lines","number of dotted lines between the obtained solid lines","number of solid lines","number of dotted lines",1,doNothing,200,370,350,160);	
	}
...
function spanToDraw()
{
	...
	{
		ctx.beginPath();
		ctx.moveTo(grid_size*(borex/100),-grid_size*(borey/100));
		boreInt = setInterval(function(){markBoreholeLine();},25);
		spanclick =16;
	}
}
...
function markBoreholePoint()
{
	...
	ctx.strokeStyle="red";
	ctx.fillStyle="blue";
	ctx.arc(grid_size*(borex/100),-grid_size*(borey/100),5,0,2*Math.PI,true);
	ctx.fill();
	ctx.stroke();
	ctx.closePath();
	document.getElementById("nextButton").style.visibility = "visible";
...
//--------------Mark borehole point()
function markBoreholeLine()
{
	ctx.lineTo(grid_size*(borex/100),-grid_size*((borey)/100));
	boreArrow(borex,borey);
	...
	if (borey==boreDepth) 
	{
		clearInterval(boreInt);
		boreHoleNaming(borex,borey);
		var q2 = Object.create(questions);												
		generateQuestion(q2,"What is the depth of borehole?","","150m","200m","350m","120m",4,nextButtonProceed,100,150,300,120);
		// document.getElementById("nextButton").style.visibility = "visible";
		ctx.closePath();
	}
}
...
function boreArrow()
{
	...
	ctx.lineWidth = "1";
	ctx.moveTo(grid_size*((borex-2)/100),-grid_size*((borey+2)/100));
	ctx.lineTo(grid_size*(borex/100),-grid_size*(borey/100));
	ctx.lineTo(grid_size*((borex+2)/100),-grid_size*((borey+2)/100));
	ctx.stroke();
	ctx.closePath();
}

function boreHoleNaming(ptx,pty)
{
	ctx.beginPath()
	ctx.strokeStyle = "black";
	ctx.fillStyle = "black";
	ctx.font = " bold 16px verdana";
	ctx.moveTo(grid_size*(640/100),-grid_size*(340/100));
	ctx.lineTo(grid_size*((640+70)/100),-grid_size*(340/100));
	ctx.moveTo(grid_size*(ptx/100),-grid_size*(pty/100));
	ctx.lineTo(grid_size*((ptx+70)/100),-grid_size*(pty/100));
	ctx.moveTo(grid_size*((640+50)/100),-grid_size*(340/100));
	ctx.lineTo(grid_size*((ptx+50)/100),-grid_size*(pty/100));
	ctx.fillText("120m",grid_size*(750/100),-grid_size*(280/100),30);
	ctx.stroke();
}
...
function drawqpattern()
{
	...
	{
		ctx.beginPath();
		ctx.arc(grid_size*(i/100),-grid_size*(200/100),2,0,2*Math.PI,false);
		ctx.stroke();
		ctx.closePath();
	}
